...
public class Movie {
    ...
    public Movie(long id_, String name_, String summary_, String releaseDate_, String director_, List<String> writers_, List<String> genres_, List<Long> cast_, double imdbRate_, long duration_, long ageLimit_, String image_, String coverImage_) throws IOException {
        id = (long) id_;
        (name = name_).equals("");
